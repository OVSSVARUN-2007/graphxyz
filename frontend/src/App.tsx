...
import { evaluateMath, analyzeNLP, fetchPresets } from './services/api';
  ...
  const handleAnalyzeNLP = async (
    ...
    try {
      ...
      const newHistoryItem: HistoryItem = {
        ...
        dimension: dim === 'AUTO' ? (res.analysis.recommendation.recommended_visualization.includes('3D') ? '3D' : '2D') : dim,
