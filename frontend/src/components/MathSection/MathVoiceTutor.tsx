...
import { Volume2, VolumeX, Sparkles, BookOpen, ChevronDown, ChevronUp, RefreshCw, Cpu } from 'lucide-react';
...
export const MathVoiceTutor: React.FC<MathVoiceTutorProps> = ({ equation }) => {
  ...
  return (
    <div className="glass-card rounded-2xl border border-sky-800/40 bg-gradient-to-br from-[#040e1f]/90 via-[#030914]/90 to-[#0c0419]/90 overflow-hidden shadow-xl shadow-sky-950/20">
      ...
      <div className="p-4 flex items-center justify-between cursor-pointer hover:bg-slate-900/40 transition-colors" onClick={() => setIsOpen(!isOpen)}>
