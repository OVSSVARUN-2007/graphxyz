...
import { AlertCircle, ArrowRight, Award, CheckCircle2, RefreshCw, Sparkles, Target, Trophy } from "lucide-react";
                    ...
                    <div className="flex items-center gap-2.5">
                        ...
                        <div>
                            <div className="text-xs font-bold">
                                {result.passed
                                    ? "🎉 Target Matched Perfectly!"
                                    : "Almost there! Keep tweaking your equation."}
                            </div>
