...
export const EquationInput: React.FC<EquationInputProps> = ({
    ...
    return (
        <div className="space-y-4">
            {/* Top All-in-One Vibrant Studio Switcher Bar */}
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-1.5 p-2 bg-slate-950/90 rounded-2xl border border-slate-800 shadow-xl backdrop-blur-md">
                <button
                    type="button"
                    onClick={() => {
                        setPrimaryTab("single");
                ...
                <button
                    ...
                    className={`flex items-center justify-center gap-1.5 py-2 px-2.5 rounded-xl text-xs font-bold transition-all ${
                        primaryTab === "quantum"
                            ? "bg-gradient-to-r from-cyan-400 to-teal-500 text-slate-950 shadow-md shadow-cyan-500/25 scale-[1.02]"
                            : "text-slate-400 hover:text-slate-200 hover:bg-slate-900"
                    }`}
                >
                ...
                <button
                    ...
                    className={`flex items-center justify-center gap-1.5 py-2 px-2.5 rounded-xl text-xs font-bold transition-all ${
                        primaryTab === "fractal"
                            ? "bg-gradient-to-r from-indigo-500 to-violet-500 text-white shadow-md shadow-indigo-500/25 scale-[1.02]"
                            : "text-slate-400 hover:text-slate-200 hover:bg-slate-900"
                    }`}
                >
            ...
            {primaryTab === "single" && (
                <div className="glass-card rounded-2xl p-5 border border-slate-800/80 bg-slate-900/60 shadow-xl space-y-4">
                    ...
                    {/* Mode 4: AI Copilot */}
                    {inputMode === "copilot" && <AICopilotPrompt onEquationGenerated={handleCopilotGenerated} />}

                    {/* 4D Time Evolution Player (if t parameter is in formula) */}
                    {isTimeEq && (
                        <TimeEvolutionPlayer time={timeVal} setTime={setTimeVal} onTimeStep={handleTimeStep} />
                    )}
                    ...
                    <div>
                        ...
                        >
                            ...
                            <span>
                                {showAudio ? "Hide Audio Sonification" : "Listen to Equation Audio (Web Audio Synth)"}
                            </span>
                        </button>

                        {showAudio && <AudioSonificationPanel equation={equation} mathData={mathData} />}
                    </div>
                    ...
                    <div>
                        ...
                        >
                            ...
                            <span>
                                {showCalculus
                                    ? "Hide Calculus Intelligence Tools"
                                    : "Show Calculus Tools (Tangents & Integrals)"}
                            </span>
                        </button>
                    ...
                    <div>
                        ...
                        >
                            ...
                            <span>
                                {showAdvanced
                                    ? "Hide Domain Ranges & Mesh Settings"
                                    : "Custom Domain Ranges & Resolution"}
                            </span>
                        </button>
