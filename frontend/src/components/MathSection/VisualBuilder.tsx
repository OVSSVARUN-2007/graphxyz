...
import { Sparkles, Heart, Globe, Waves, Donut, CircleDot, Activity, Orbit } from 'lucide-react';
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
          {templates.map((tpl) => {
            ...
            return (
              ...
              >
                <div className={`w-8 h-8 rounded-lg bg-gradient-to-tr ${tpl.color} flex items-center justify-center shadow-sm`}>
