...
import { Box, Layers, Download, Check, X, Printer, ShieldCheck } from 'lucide-react';
...
export const ThreeDPrintModal: React.FC<ThreeDPrintModalProps> = ({
  isOpen,
  onClose,
  mathData,
  currentEquation,
        ...
        <div className="p-4 border-b border-slate-800 flex items-center justify-between bg-slate-950/60">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400">Generate watertight solid meshes for 3D printing</p>
            </div>
          </div>
          <button
            onClick={onClose}
