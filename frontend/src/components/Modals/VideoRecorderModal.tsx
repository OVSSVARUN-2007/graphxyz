...
import { Video, Film, Play, Square, Download, RefreshCw, X, Sparkles } from 'lucide-react';
        ...
        <div className="p-4 border-b border-slate-800 flex items-center justify-between bg-slate-950/60">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400">Record smooth 60 FPS rotating camera animations</p>
            </div>
          </div>
          <button
            onClick={onClose}
            ...
            <div className="p-6 bg-slate-900/60 rounded-xl border border-slate-800 text-center space-y-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 max-w-xs mx-auto mt-1">
                  Spins the 3D camera smoothly around your graph and packages it into an HD video clip.
                </p>
              </div>
