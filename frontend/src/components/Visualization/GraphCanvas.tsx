...
import { Compass, Sparkles, Activity, Layers, BarChart3, LineChart } from 'lucide-react';
        ...
        if (sentPoints.length > 0) {
          traces.push({
            ...
            marker: {
              ...
              color: sentPoints.map((p, i) =>
                selectedSentenceIndex === i + 1 ? '#22d3ee' : '#a855f7'
              ),
